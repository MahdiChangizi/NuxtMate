    ...
    <transition name="slide-up" @click="close" class="cursor-pointer">
        <div v-show="status" class="toast toast-top toast-center z-[1050]">
            <div role="alert" class="alert shadow-lg flex items-center justify-center">
                ...
                <svg v-show="props.type == 'error' " xmlns="http://www.w3.org/2000/svg" class="stroke-current shrink-0 h-6 w-6 text-red-500" fill="none" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <svg v-show="props.type == 'success' " xmlns="http://www.w3.org/2000/svg" class="stroke-current shrink-0 h-6 w-6 text-green-500" fill="none" viewBox="0 0 24 24">
