...
const _routes = [
  {
    name: "dashboard",
    path: "/dashboard",
    component: () => import('./dashboard-BsPhZtiu.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-D7l7Dbmi.mjs').then((m) => m.default || m)
  },
  {
    name: "page-2",
    path: "/page-2",
    component: () => import('./page-2-D8sBtN1l.mjs').then((m) => m.default || m)
  },
  {
    name: "profile",
    path: "/profile",
    component: () => import('./profile-Ck0yvs-M.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./default-D7olJSsm.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Df2mLGjZ.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-C9bPTPhK.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, resolveRouteObject as a, navigateTo as b, useRuntimeConfig as c, entry$1 as default, injectHead as i, nuxtLinkDefaults as n, resolveUnrefHeadInput as r, useRouter as u };
