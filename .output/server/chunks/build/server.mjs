import { version, unref, inject, defineComponent, ref, provide, createElementBlock, h, computed, shallowReactive, watch, Suspense, nextTick, Fragment, Transition, hasInjectionContext, mergeProps, useSSRContext, createApp, effectScope, reactive, getCurrentScope, getCurrentInstance, isRef, isReactive, toRaw, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, onScopeDispose, defineAsyncComponent, shallowRef, isReadonly, toRefs, markRaw, withCtx, isShallow } from 'vue';
...
const _routes = [
  {
    name: "dashboard",
    path: "/dashboard",
    component: () => import('./dashboard-DYO4t-9F.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-B6zPcK1Z.mjs').then((m) => m.default || m)
  },
  {
    name: "page-2",
    path: "/page-2",
    component: () => import('./page-2-D8ryx1fL.mjs').then((m) => m.default || m)
  },
  {
    name: "profile",
    path: "/profile",
    component: () => import('./profile-BBEsyalP.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./default-CZR5FaZv.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DV8Bqu4j.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, resolveRouteObject as a, navigateTo as b, useRuntimeConfig as c, defineStore as d, entry$1 as default, injectHead as i, nuxtLinkDefaults as n, resolveUnrefHeadInput as r, useRouter as u };
